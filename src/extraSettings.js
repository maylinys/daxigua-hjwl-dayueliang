...
//const minRandomFruitNum = reverseLevelUp ? 11 : 11; // 生成随机水果最小值（0-10）0 为葡萄，9 为半个西瓜
...
let setFruits = {
  ...
  //startFruits: reverseLevelUp ? [10, 10, 9, 8, 8, 7] : [8, 8, 7, 6, 5, 4],
  randomFunction: () => {
...
// 修改网页标题：将 "合成大西瓜" 进行替换
document.getElementsByTagName("title")[0].innerText = 'HJWL-合成大月亮';
